...
var loginResponseEndpoint = {
    path: '/multi-auth/auth/verify',
    method: 'post',
    root: true,
    handler: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var body, user, passkeys, passkey, verification, error_1, verified, password, loginData, result, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    passkeys = _a.sent();
                    passkey = passkeys.find(function (existingPasskey) { return existingPasskey.credentialID === body.asseResp.id; });
                    if (!passkey) {
...
exports.default = loginResponseEndpoint;
