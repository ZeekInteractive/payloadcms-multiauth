...
var loginChallengeEndpoint = {
    path: '/multi-auth/auth/challenge',
    method: 'post',
    root: true,
    handler: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var user, userPasskeys, options;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!req.body || !req.body.email) {
                        return [2 /*return*/, res.status(400).json({ message: 'Email missing' })];
                    }
                    return [4 /*yield*/, (0, utils_1.getUserByEmail)(req.body.email, req.payload, pluginConfig_1.default.authCollectionSlug)];
                case 1:
                    user = _a.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, server_1.generateAuthenticationOptions)({
                            rpID: 'localhost',
                            allowCredentials: userPasskeys.map(function (passkey) { return ({
                ...
                case 3:
                    ...
                    return [4 /*yield*/, req.payload.update({
                            ...
                            id: user.id,
                            data: { registrationOptions: options },
                        })];
                case 4:
                    _a.sent();
                    res.json(options);
...
exports.default = loginChallengeEndpoint;
